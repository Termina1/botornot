...
# list of vk ids
#
botids <- as.character(c(2011654,30051689,79185386,83849263,162198132,168816190,203222567,211504594,250265640,263795514,78380416,264961685))
botids <- as.list(botids)
#botids[[1]] <- "12876"
#botids[[2]] <- "245216"
...
for (k in 1:length(botids)){
  ...
  write.graph(g, file = paste0("data/graph/", botids[[k]], ".gml"), format = "gml")
  graphList[[k]] <- g
}